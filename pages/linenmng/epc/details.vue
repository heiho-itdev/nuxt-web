  ...
  <div class="">
      <b-col>
        ...
        <b-card v-show="activeTab === '2'">
         <b-row>
            <b-col sm="4">
             <b-button type="submit" size="md" variant="success" class="rounded mr-2">納品書作成</b-button>
             <b-button type="submit" size="md" variant="primary" class="rounded mr-2">ダウンロード</b-button>
            </b-col>
          </b-row>
          <br>
          <b-row>
            <b-col sm="4">
              <img src="/img/delivery-note-sample.png"/>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="12">
              <div id="canvas-area">
                  ...
                  <div id="tool-area">
                  <button id="download-button" @click="download">登録</button>
